var UbicacionFarmaciaView = (function (_, common, BaseView) {
    "use strict";
    
    var ubicacionFarmaciaView = BaseView.extend({
        tagName: 'div',
        className: 'ubicacionView',
        
        attributes: {
            'id': 'resultadoConsultaFarmacia'
        },
    ...
    */
    ubicacionFarmaciaView.prototype.getModelData = function () {
        var jsonData = {};
    ...
    */
    ubicacionFarmaciaView.prototype.getNumeroTelefonoFormateado = function (telefonoModel) {
        return telefonoModel.get("tipo") + " - " + telefonoModel.get("numero");
    };
    
    return ubicacionFarmaciaView;
}(_, common, BaseView));
